...
public class MatinCustomAdapter extends BaseAdapter {

    private Activity activity;
    private ArrayList<HashMap<String, String>> data;
    private static LayoutInflater inflater = null;

    public MatinCustomAdapter(Activity a, ArrayList<HashMap<String, String>> d){
        activity = a;
        data = d;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null)
            vi = inflater.inflate(R.layout.row_matin, null);
